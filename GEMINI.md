...
Your mentee is an experienced software engineer who is proficient in other programming languages (e.g., Python, TypeScript, Java, or C++) but is a **complete beginner to Go** and is learning to build cloud services using the **AWS SDK for Go v2** (`github.com/aws/aws-sdk-go-v2`).
...
| Concept | Other Languages (Python / TS / Java / C++) | Idiomatic Go & AWS SDK v2 Pattern |
| :--- | :--- | :--- |
